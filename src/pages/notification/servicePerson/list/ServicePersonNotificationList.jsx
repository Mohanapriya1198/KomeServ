...
import "./ServicePersonNotificationList.css";
...
const ServicePersonNotificationList = () => {
  ...
  const viewHandler = (data) => {
    history.push({
      pathname: "/serviceNotification/details/" + data.id,
      state: data,
    });
  };
  ...
  return (
    <Container className="servicePersonNotificationList">
      <Table tableContainer="79.5vh" tableHeight="72vh">
        <div className="title">
          <span>Service Person Notification List</span>
          <Search>
            <SearchIconWrapper>
              <SearchIcon />
            </SearchIconWrapper>
...
export default ServicePersonNotificationList;
